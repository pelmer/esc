...
//
	RanSetRan("MWC8222");
	RanSetSeed(NULL, 0);
	gen = unif01_CreateExternGen01 ("Polar-MWC8222", DRanQuanNormal);
	bbattery_Crush (gen);
	unif01_DeleteExternGen01 (gen);
//
//	RanNormalSetSeedRNOR(NULL, 0);
//	gen = unif01_CreateExternGen01 ("RNOR-SHR3", DRanQuanNormalRNOR);
//	bbattery_Crush (gen);
//	unif01_DeleteExternGen01 (gen);
//
//	RanSetRan("MWC8222");
//	RanNormalSetSeedRNOR_MWC8222(NULL, 0);
//	gen = unif01_CreateExternGen01 ("RNOR-MWC8222", DRanQuanNormalRNOR_MWC8222);
//	bbattery_Crush (gen);
//	unif01_DeleteExternGen01 (gen);
//
//	RanSetRan("MWC8222");
