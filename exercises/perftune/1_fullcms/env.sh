...
#
#+
if [ X/opt/g4//geant4.9.3.p02 != X/opt/g4// ] ; then
    G4INSTALL="/opt/g4///src/geant4"
else
    G4INSTALL="/opt/g4//geant4.9.3.p02"
fi
export G4INSTALL
if [ X$g4non_display = X ] ; then
...
if [ Xn != Xn ] ; then 
    if [ X/opt/g4//geant4.9.3.p02 != X/opt/g4// ] ; then
        G4INCLUDE="/opt/g4///include/geant4"
    else
        G4INCLUDE="/opt/g4//geant4.9.3.p02/include/"
    fi
    export G4INCLUDE
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/opt/g4//geant4.9.3.p02/lib != X ] ; then 
    if [ X/opt/g4//geant4.9.3.p02 != X/opt/g4// ] ; then
        G4LIB="/opt/g4///lib/geant4"
    else
        G4LIB="/opt/g4//geant4.9.3.p02/lib"
    fi
    export G4LIB
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/opt/g4//geant4.9.3.p02/data/PhotonEvaporation2.0 != X ] ; then 
    G4LEVELGAMMADATA="/opt/g4//geant4.9.3.p02/data/PhotonEvaporation2.0"
...
#+
if [ X/opt/g4//geant4.9.3.p02/data/RadioactiveDecay3.2 != X ] ; then 
    G4RADIOACTIVEDATA="/opt/g4//geant4.9.3.p02/data/RadioactiveDecay3.2"
...
#+
if [ X/opt/g4//geant4.9.3.p02/data/G4EMLOW6.9 != X ] ; then 
    G4LEDATA="/opt/g4//geant4.9.3.p02/data/G4EMLOW6.9"
    export G4LEDATA
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/opt/g4//geant4.9.3.p02/data/G4NDL3.13 != X ] ; then 
    G4NEUTRONHPDATA="/opt/g4//geant4.9.3.p02/data/G4NDL3.13"
...
#+
if [ X/opt/g4//geant4.9.3.p02/data/G4ABLA3.0 != X ] ; then 
    G4ABLADATA="/opt/g4//geant4.9.3.p02/data/G4ABLA3.0"
    export G4ABLADATA
    if [ X$g4non_display = X ] ; then
...
#+
if [ X/opt/g4//geant4.9.3.p02/data/RealSurface1.0 != X ] ; then 
    G4REALSURFACEDATA="/opt/g4//geant4.9.3.p02/data/RealSurface1.0"
...
#+
if [ X/opt/g4///include != X ] ; then 
    CLHEP_INCLUDE_DIR="/opt/g4///include"
...
#+
if [ X/opt/g4///lib != X ] ; then 
    CLHEP_LIB_DIR="/opt/g4///lib"
